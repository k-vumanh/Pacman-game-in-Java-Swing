...
public class Ghost3 extends Entity{
    ...
    public void getGhostImage() {
        try {
            up1 = new ImageIcon(getClass().getResource("/ghost/pink_ghost_up.png"));
            down1 = new ImageIcon(getClass().getResource("/ghost/pink_ghost_down.png"));
            left1 = new ImageIcon(getClass().getResource("/ghost/pink_ghost_left.png"));
            right1 = new ImageIcon(getClass().getResource("/ghost/pink_ghost_right.png"));
