...
public class Ghost1 extends Entity {
    ...
    public void getGhostImage() {
        try {
            up1 = new ImageIcon(getClass().getResource("/ghost/ghost_up.png"));
            down1 = new ImageIcon(getClass().getResource("/ghost/ghost_down.png"));
            left1 = new ImageIcon(getClass().getResource("/ghost/ghost_left.png"));
            right1 = new ImageIcon(getClass().getResource("/ghost/ghost_right.png"));
